...
for a buffer in which to place the data.  Then it reads from the socket directly
into the buffer and notifies the receiver that bytes have been received.  The 
SocketReaderWriter also notifies the receiver if the connection is lost. 
